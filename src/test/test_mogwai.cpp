...
#define BOOST_TEST_MODULE Mogwai Test Suite

#include "test_mogwai.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_mogwai_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
