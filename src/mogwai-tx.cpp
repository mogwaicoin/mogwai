...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Mogwai Core mogwai-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  mogwai-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mogwai transaction") + "\n" +
              "  mogwai-tx [options] -create [commands]   " + _("Create hex-encoded mogwai transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded mogwai transaction
