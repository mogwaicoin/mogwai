...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "MogwaiNetwork") type = MogwaiNetwork;
    if(strType == "MogwaiNetworkVariable") type = MogwaiNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == MogwaiNetwork) s = "MogwaiNetwork";
    if(type == MogwaiNetworkVariable) s = "MogwaiNetworkVariable";
