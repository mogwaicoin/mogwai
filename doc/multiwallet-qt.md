...
Only requiring some minor changes is mogwai.cpp.
...
Changes to mogwai.cpp
----------------------
mogwai.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
